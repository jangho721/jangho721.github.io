...
<section class="container mt-5">
    <div class="row">
        <div class="col-sm mt-3 mt-md-0">
            <h2 style="font-weight: bold; font-size: 1.5rem;">About</h2>
            <div class="row">
            ...
            <h2 style="font-weight: bold; font-size: 1.5rem;">Challenges</h2>
            <p>
                유저의 프라이버시를 보호하면서 마케팅 채널별 기여도 확인하기<br>
                런칭 초기 멜리즈는 신규 유저 획득을 위한 대대적인 투자를 진행한 뒤, 성장 모멘텀을 유지할 수 있는 다양한 전략을 취했습니다.
            </p>
            <h2 style="font-weight: bold; font-size: 1.5rem;">Solutions</h2>
            <p>
            ...
            <h2 style="font-weight: bold; font-size: 1.5rem;">Final thoughts</h2>
            <p>
